...
/// Album art widget with tap-to-show-lyrics overlay.
///
/// Used by [StandardPlayer] in its normal (non-lyrics) mode.
/// Tapping the art calls [PlayerController.showLyrics] which sets
/// [showLyricsflag] and causes [StandardPlayer] to switch to the
/// lyrics layout via AnimatedSwitcher.
    ...
    return Obx(() => playerController.currentSong.value != null
        ? Stack(
            children: [
              ...
              // Lyrics overlay when showLyricsflag is true
              // (only visible briefly before AnimatedSwitcher transitions)
