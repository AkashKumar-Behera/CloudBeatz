...
/// Album art widget used by the standard player.
///
/// NOTE: The lyrics-overlay behaviour has been moved to [StandardPlayer]'s
/// dedicated Page-1 lyrics screen.  This widget only shows the artwork,
/// long-press song-info sheet, horizontal swipe for next/prev, and the
/// optional sleep-timer badge.
    ...
    return Obx(() => playerController.currentSong.value != null
        ? Stack(
            children: [
              ...
              // Sleep-timer badge (shown when active)
