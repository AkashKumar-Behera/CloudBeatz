...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        "bg": {
          ...
          "backgroundPlayDes":
              "Активирай/Деактивирай изпълнение на музика във фонов режим (Приложението може да бъде достъпно от системната област, когато приложението работи във фонов режим)",
          ...
          "resetToDefaultMsg":
              "Нулирането на настройките по подразбиране завърши, Моля, рестартирайте приложението",
          "resetToDefaultDes":
              "Нулиране на настройките на приложението по подразбиране (изисква се рестартиране)",
          "misc": "Разни",
        ...
        "ca": {
          ...
          "downloadError3":
              "Ha fallat la descàrrega a causa d'un error de xarxa! Torneu-ho a provar",
        ...
        "fa": {
          ...
          "downloadError3":
              "دانلود به علت خطای شبکه شکست خورد! لطفا دوباره تلاش کنید",
          "content": "محتوا",
          "downloadError2":
        ...
        "id": {
          ...
          "disableTransitionAnimationDes":
              "Aktifkan opsi ini untuk menonaktifkan animasi transisi tab",
          "queuerearrangingDeniedMsg":
          ...
          "upNext": "Selanjutnya",
          "downloadError3":
              "Unduhan gagal karena kesalahan jaringan/stream! Silakan coba lagi.",
        ...
        "ku": {},
        "ml": {"songs": "പാട്ടുകൾ", "home": "ഹോംപേജ്"},
        "my": {},
        "nb_NO": {
          "home": "Hjem",
          "low": "Lav",
        ...
        "ro": {
          ...
          "autoDownFavSongDes":
              "Descarcă automat melodiile preferate când sunt adăugate la preferate",
          ...
          "queuerearrangingDeniedMsg":
              "Coada nu poate fi rearanjată când modul de amestecare este pornit",
          "songNotPlayable":
        ...
        "ru": {
          ...
          "autoDownFavSongDes":
              "Автоматически загружать любимые песни при добавлении в избранное",
        ...
        "vi": {
          ...
          "autoDownFavSongDes":
              "Tự động tải bài hát về sau khi thêm vào danh sách yêu thích",
